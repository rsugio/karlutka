package ru.rsug.karlutka.schemas
...
private const val xmlNsXsd = "http://www.w3.org/2001/XMLSchema"
...
class Xsd {
    ...
    companion object {
        ...
        fun decodeFromString(xsdText: String): Schema {
            return xml2.decodeFromString(xsdText)
        }

        fun decodeFromStream(ins: InputStream): Schema {
