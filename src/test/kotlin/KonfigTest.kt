...
class KonfigTest {
    ...
    fun karla() {
        ...
        show(k1)
        require(k1.targets.size == 2 && k1.targets[0] is KfTarget.ABAP && k1.targets[1] is KfTarget.PIAF)
...
//        val t3 = Target.BTPNEO("azc20mq", "https://api.eu3.hana.ondemand.com")
...
//        val t7 = Targe.JDBCt("e10001", "https://e10001.tmn.eu3.hana.ondemand.com")
        ...
        val k1 = Kfg(mutableListOf(t1, t2))
