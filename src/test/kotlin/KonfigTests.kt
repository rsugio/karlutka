...
class KonfigTests {
    ...
    fun karla() {
        ...
        val fae = k1.targets[5] as KfTarget.FAE
        require(fae.cae=="PID")
    ...
    fun prints() {
        ...
        val t4 = KfTarget.CPINEO("e10001", null, "https://e10001.tmn.eu3.hana.ondemand.com", "?")
        require(t4.auth.isNotBlank())
    ...
    @Test
    fun fae() {
        KfPasswds.parse(Paths.get("C:/data/passwd_fae.yaml"))
        Kfg.parse(Paths.get("C:/data/karla_fae.yaml"))
    }
}
